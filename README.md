...
You can install the development version of regexcitealytow from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("alysentownsley/regexcitealytow")
```
...
That’s exactly what `regexcitealytow::str_split_one()` does.

``` r
library(regexcitealytow)
